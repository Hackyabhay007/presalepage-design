...
const ScrollingNews = () => {
  return (
    <div className=" relative top-20 left-0 right-0 z-50 bg-accent-500/10 backdrop-blur-sm border-b border-accent-500/20">
      <div className="container mx-auto">
        <div className="overflow-hidden py-3">
          <div className="animate-scrolling-news inline-flex items-center space-x-12 whitespace-nowrap">
            {[1, 2, 3].map((_, index) => (
              <div key={index} className="flex items-center space-x-12">
                <div className="flex items-center space-x-3">
                  <img src="https://static.airpackapp.com/static/logo/open_sesame_night.png?w=750&q=75" alt="Gate.io" className="h-6 w-auto" />
                  <span className="text-accent-400 font-medium">Gate.io Listing</span>
                </div>
                <div className="flex items-center space-x-3">
                  <img src="https://s2.coinmarketcap.com/static/img/exchanges/64x64/544.png" alt="MEXC" className="h-6 w-auto" />
                  <span className="text-accent-400 font-medium">MEXC Listing</span>
                </div>
                <div className="text-secondary-400 font-medium">
                  Listing Price: $0.005 | Next Month
                </div>
              </div>
            ))}
          </div>
...
const PresaleHero = () => {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-background">
      <ScrollingNews />
      {/* Add padding-top to account for fixed ScrollingNews */}
      <div className="pt-16">
